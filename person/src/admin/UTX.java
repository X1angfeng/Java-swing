...
public class UTX extends JPanel implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4031030754886556264L;
	JLabel jl1;
	JTable jt1;
	...
	String userName="sa";
	String userPwd="123";
	String[] title = {"用户","电话","联系人姓名","城市","工作地点","备注"};
	Object[][]  A={};
	int count;	
	public UTX()
	{
		...
		jl1 = new JLabel("用户通讯录管理");
		jl1.setFont(new Font("",1,30));
		jl1.setForeground(Color.BLUE);
		jb1 = new JButton("修改通讯信息");
		jb2 = new JButton("删除通讯信息");
...
try 
    ...
    String r1="select * from communication";
    ResultSet rs=s.executeQuery(r1);
           ...
           while(rs.next())
		   {
		    ...
		    {   A[count][0]=rs.getString("ID");
		    	A[count][1]=rs.getString("telephone");
		    	A[count][2]=rs.getString("cname");
		    	A[count][3]=rs.getString("city");
		    	A[count][4]=rs.getString("place");
		    	A[count][5]=rs.getString("remarks");
