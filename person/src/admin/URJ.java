...
public class URJ extends JPanel implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3047600256236768151L;
	JLabel jl1;
	JTable jt1;
	...
	public URJ()
	{
		...
		jl1 = new JLabel("用户日记管理");
		jl1.setFont(new Font("",1,30));
		jl1.setForeground(Color.BLUE);
		jb1 = new JButton("修改日记信息");
		jb2 = new JButton("删除日记信息");
    ...
    ResultSet rs=s.executeQuery(r1);
           ...
           while(rs.next())
		   {
		    ...
		    {   A[count][0]=rs.getString("ID");
		    	A[count][1]=rs.getString("dtime");
		    	A[count][2]=rs.getString("weather");
		    	A[count][3]=rs.getString("devent");
