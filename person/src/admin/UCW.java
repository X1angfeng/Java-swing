...
public class UCW extends JPanel implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3849518943964607898L;
	JLabel jl1;
	JTable jt1;
	...
	String userName="sa";
	String userPwd="123";
	String[] title = {"用户","消费时间","消费项目","消费金额","收入","剩余资金"};
	Object[][]  A={};
	int count;	
	public UCW()
	{
		...
		jl1 = new JLabel("用户财务管理");
		jl1.setFont(new Font("",1,30));
		jl1.setForeground(Color.BLUE);
		jb1 = new JButton("修改财务信息");
		jb2 = new JButton("删除财务信息");
    ...
    ResultSet rs=s.executeQuery(r1);
           ...
           while(rs.next())
		   {
		    ...
		    {   A[count][0]=rs.getString("ID");
		    	A[count][1]=rs.getString("ftime");
		    	A[count][2]=rs.getString("project");
		    	A[count][3]=rs.getString("fmoney");
		    	A[count][4]=rs.getString("income");
		    	A[count][5]=rs.getString("Balance");
